...
import com.development.cancerdetection.databinding.ItemArticlesBinding
import com.development.cancerdetection.helper.DateHelper
...
class ArticleAdapter : ListAdapter<ArticlesItem, ArticleAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    class MyViewHolder(private val binding: ItemArticlesBinding) :
        ...
        fun bind(article: ArticlesItem) {
            ...
            binding.tvPublishedAt.text = DateHelper.formatDate(article.publishedAt!!)
